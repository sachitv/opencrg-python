...
latex_documents = [
    (master_doc, 'opencrg.tex', u'opencrg Documentation',
...
man_pages = [
    (master_doc, 'opencrg', u'opencrg Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opencrg', u'opencrg Documentation',
     author, 'opencrg', 'One line description of project.',
     'Miscellaneous'),
]
